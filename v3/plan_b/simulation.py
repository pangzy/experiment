...
unfinished_a_fcfs = simulate_fcfs(glbv, a_fcfs)
...
unfinished_c_fcfs = simulate_fcfs(glbv, c_fcfs)
...
res_fcfs_p = stats(a, unfinished_a, a_fcfs, unfinished_a_fcfs)
res_fcfs_imp = stats(c, unfinished_c, c_fcfs, unfinished_c_fcfs)


output(glbv, res_perfect, "perfect")
output(glbv, res_imperfect, "imperfect")

output(glbv, res_fcfs_p, "fcfs_perfect")
output(glbv, res_fcfs_imp, "fcfs_imperfect")

if glbv["wrt"] == "y":
    wrt(glbv, res_perfect, glbv["result_file"], 1)
    wrt(glbv, res_imperfect, glbv["result_file"], 2)
    wrt(glbv, res_fcfs_p, glbv["result_file"], 3)
    wrt(glbv, res_fcfs_imp, glbv["result_file"], 4)
